/**
 * Fenetre de recherche des circuits
 * @author Jeremy
 */
...
public class RechCircuit extends JPanel implements ActionListener {
    ...
    public RechCircuit() {
        ...
        this.panelHaut.setBackground(Color.green);
        ...
        this.lblMessage = new JLabel("Circuit - recherche");
        this.lblSupp1 = new JLabel("Entrez le nom du circuit : ");
        ...
        this.btnValider1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String nomCircuit = jtfSupp1.getText();
                String result = Modele.rechercheCircuit(nomCircuit);
